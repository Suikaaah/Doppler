...
class Engine {
private:
  static constexpr std::string_view root_path{ "C:\\Users\\Suika\\Desktop\\0\\osu\\Songs" };
  ...
  Vector<float, 2> m_source_pos{ SDL::resolution.convert<float>() * 0.5f }, m_source_vel, m_source_acc,
  ...
  Timer                    m_timer_draw{ 1000 / SDL::fps };
